...
if (isset($_REQUEST["submit"])) {
    ...
    $ins = "INSERT INTO members (id,name, date,dob,phone,coach) VALUES ('$id','$name','$date','$dob','$phone','$coach')";
...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  <a class="navbar-brand" href="admin-login.php"><img src="img/TT.jpg" alt="Fitness Club Logo"></a>
